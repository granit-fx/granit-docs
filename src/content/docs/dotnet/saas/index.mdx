...
description: Build SaaS with Granit — subscriptions, invoicing with credit notes, provider-agnostic payments, and usage metering. Sovereign, no US cloud lock-in.
sidebar:
  label: Overview
  order: 0
---
...
Granit provides a complete SaaS & Commerce ecosystem through seven interdependent modules.
...
|--------|---------|-------|
| [Catalog](/dotnet/saas/catalog/) | Shared `Product` aggregate joining Metering, Subscriptions, and Invoicing — Draft/Published/Archived lifecycle | 1 |
