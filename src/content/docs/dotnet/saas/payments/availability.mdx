...
description: Provider-driven payment method catalogue, capability snapshots on PaymentMethodConfiguration, runtime filtering by country, currency, amount, sequence.
sidebar:
  label: Availability
  order: 2
---
