...
description: Subscription plans with Draft/Published/Archived lifecycle, 6-state FSM, per-seat pricing, scheduled changes, and billing orchestration. Stripe or internal.
sidebar:
  label: Subscriptions
  order: 1
---
...
|----------|---------|-------------|
| Internal | `Granit.Subscriptions.Builtin` | None (no-op, zero dependency) |
