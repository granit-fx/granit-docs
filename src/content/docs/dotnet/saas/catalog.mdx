...
description: Shared Product aggregate joining Metering, Subscriptions, and Invoicing — Draft/Published/Archived lifecycle, extras, and Stripe/Avalara/Odoo mappings.
sidebar:
  label: Catalog
  order: 7
---
