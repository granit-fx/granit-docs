...
description: Deliver notifications via AWS SES email, AWS SNS SMS, mobile push, WhatsApp, SignalR, and Web Push with user preference filtering and delivery tracking.
sidebar:
  order: 4
...
dotnet add package Granit.Notifications.AzureNotificationHubs
```
...
builder.Services.AddGranitNotificationsSmtp();
