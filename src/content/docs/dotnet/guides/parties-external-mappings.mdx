...
description: Wire a new billing or accounting provider into Granit by storing its customer ID directly on the Party via Party.ExternalMappings.
sidebar:
  order: 32
...
- [Granit.Parties module reference](/dotnet/business/parties/) (TODO once the
...
- [Parties module](/dotnet/business/parties/) — Party aggregate and module reference
- [Seed the default party at tenant provisioning](/dotnet/guides/parties-tenant-seeding/) — sibling guide using the same `tenant` mapping
- [Auto-maintain Party.Roles via integration events](/dotnet/guides/parties-role-handler/) — companion handler pattern
- [Wolverine messaging](/dotnet/infrastructure/wolverine-messaging/) — integration event handler conventions
- [Multi-tenancy](/dotnet/infrastructure/multi-tenancy/) — tenant provisioning lifecycle
