...
description: Configure JSON-based modular i18n for 18 cultures with CLDR plural rules — source-generated IStringLocalizer keys and per-tenant runtime overrides.
sidebar:
  order: 10
