...
description: Define per-tenant settings with five-level cascading resolution (User, Tenant, Global, Configuration, Default), AES-256 storage, and runtime changes.
sidebar:
  order: 19
...
public sealed class AppDbContext(
    ...
    : GranitDbContext(options, currentTenant, dataFilter), ISettingsDbContext
{
