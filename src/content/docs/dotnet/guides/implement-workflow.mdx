...
description: Build a finite state machine workflow with fluent definitions, permission guards, approval routing, ISO 27001 audit trails, and notification triggers.
sidebar:
  order: 13
...
- [Workflow reference](/dotnet/building-blocks/workflow/) for the complete API surface
