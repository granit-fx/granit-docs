...
description: Build a CSV and Excel import pipeline with the Extract, Map, Validate, Execute flow — streaming IAsyncEnumerable and roundtrip INSERT/UPDATE support.
sidebar:
  order: 5
