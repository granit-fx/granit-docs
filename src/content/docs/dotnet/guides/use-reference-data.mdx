...
description: Manage multilingual lookup tables (countries, currencies) with generic EF Core CRUD endpoints, hierarchical types, caching, and ISO 27001 audit.
sidebar:
  order: 18
...
(countries, currencies, document types) with built-in i18n support for 15 languages,
