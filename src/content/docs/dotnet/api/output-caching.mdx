...
description: Multi-tenant HTTP response caching with GDPR-safe defaults — tenant isolation, tag-based eviction, and optional Redis backend via Granit.Http.OutputCaching.
sidebar:
