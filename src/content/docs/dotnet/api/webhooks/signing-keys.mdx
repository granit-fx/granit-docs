...
description: WebhookSigningKey aggregate with Active/Retired/Revoked statuses, overlap rotation, and auditable key history. ISO 27001 A.10.1 / A.8.24 compliant.
sidebar:
  label: Signing keys
  order: 3
---
