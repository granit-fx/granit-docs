...
Target URLs are validated through [`Granit.Http.UrlSafety`](/dotnet/api/url-safety/)
...
- [Wolverine module](/dotnet/infrastructure/wolverine-messaging/) — Messaging, transactional outbox
