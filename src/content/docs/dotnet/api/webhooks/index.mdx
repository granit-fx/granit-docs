...
Target URLs are validated through [`Granit.Http.Security`](/dotnet/http/security/url-safety/)
...
[URL safety reference](/dotnet/http/security/url-safety/) for the full surface.
