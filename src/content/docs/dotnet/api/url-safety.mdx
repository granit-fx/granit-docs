...
description: "Granit.Http.Security: SSRF-safe URL validation, private-network and reserved-TLD detection. Blocks cloud metadata, RFC 1918, loopback, DNS rebinding."
sidebar:
  label: URL Safety
  order: 10
---
