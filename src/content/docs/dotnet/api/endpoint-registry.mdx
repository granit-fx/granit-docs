...
| Method | Route | Operation | Auth |
|--------|-------|-----------|------|
| <Badge text="GET" variant="note" /> | `/sessions` | ListUserSessions | Authenticated |
| <Badge text="DELETE" variant="danger" /> | `/sessions/{sessionId}` | RevokeUserSession | Authenticated |
| <Badge text="DELETE" variant="danger" /> | `/sessions` | RevokeOtherUserSessions | Authenticated |
| <Badge text="GET" variant="note" /> | `/devices` | ListUserDevices | Authenticated |
