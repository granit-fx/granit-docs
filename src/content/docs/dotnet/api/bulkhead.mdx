...
description: Per-tenant concurrency isolation via System.Threading.RateLimiting — stops one tenant monopolizing threads, with feature-based quotas and Wolverine middleware.
sidebar:
  label: Bulkhead
  order: 18
---
