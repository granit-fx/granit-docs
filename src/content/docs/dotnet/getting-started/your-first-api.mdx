---
title: "Your First API — Minimal API in 15 Minutes"
description: Build your first Granit Minimal API in 15 minutes — create a [DependsOn] module, wire AddGranit() in Program.cs, and expose a validated endpoint.
sidebar:
