---
title: "Granit.QueryEngine — One declarative filter that drives your API and your grid"
description: "Stop writing filter parsing twice. QueryEngine ships a strongly-typed QueryDefinition<TEntity> that drives the API's $filter/$sort/$page, the frontend data grid's column metadata, and the OpenAPI schema — from a single declaration. EF Core-backed, SQL-injection-safe by construction, $ref-typed in OpenAPI, OData-bridgeable."
sidebar:
  label: QueryEngine
  order: 16
---
