---
title: "Rendering Pipeline — Enrich, Resolve, Layout, Render"
...
See [Layouts](/dotnet/building-blocks/templating/layouts/) for details.
...
- [Scriban Engine](/dotnet/building-blocks/templating/scriban-engine/) — stage 4 (render) deep dive
- [Layouts](/dotnet/building-blocks/templating/layouts/) — stage 3 (layout wrapping) two-pass rendering
- [Post-Render Transformers](/dotnet/building-blocks/templating/post-render-transformers/) — stage 5 (transform) extensibility
- [Lifecycle](/dotnet/building-blocks/templating/lifecycle/) — stage 2 (resolver chain) and template state machine
- [AI module](/dotnet/ai/) — `PromptBuilder` and AI enrichment integration
