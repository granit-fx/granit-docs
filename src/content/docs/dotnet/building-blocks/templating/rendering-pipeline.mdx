...
- [Scriban Engine](./scriban-engine/) — stage 4 (render) deep dive
- [Layouts](./layouts/) — stage 3 (layout wrapping) two-pass rendering
- [Post-Render Transformers](./post-render-transformers/) — stage 5 (transform) extensibility
- [Lifecycle](./lifecycle/) — stage 2 (resolver chain) and template state machine
