...
- [Rendering Pipeline](./rendering-pipeline/) — the five-stage pipeline that drives layout wrapping
- [Scriban Engine](./scriban-engine/) — sandbox, global contexts, includes
- [MJML Email Templates](./mjml-email-templates/) — the built-in `Layout.Email.html` layout
- [Lifecycle](./lifecycle/) — Draft/Published states and tenant overrides
- [Configuration & API Reference](./reference/) — public API summary and configuration options
