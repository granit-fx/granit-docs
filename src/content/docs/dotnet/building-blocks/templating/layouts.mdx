...
- [Rendering Pipeline](/dotnet/building-blocks/templating/rendering-pipeline/) — the five-stage pipeline that drives layout wrapping
- [Scriban Engine](/dotnet/building-blocks/templating/scriban-engine/) — sandbox, global contexts, includes
- [MJML Email Templates](/dotnet/building-blocks/templating/mjml-email-templates/) — the built-in `Layout.Email.html` layout
- [Lifecycle](/dotnet/building-blocks/templating/lifecycle/) — Draft/Published states and tenant overrides
- [Configuration & API Reference](/dotnet/building-blocks/templating/reference/) — public API summary and configuration options
