...
- You need **binary-first** output (PDF from scratch, not from HTML) -- go directly to [Document Generation](/dotnet/building-blocks/document-generation/)
...
to expose safe data instead. See [Scriban Engine](/dotnet/building-blocks/templating/scriban-engine/) for full sandboxing details.
:::
...
embedded templates as fallback. See [Lifecycle](/dotnet/building-blocks/templating/lifecycle/) for the full resolver chain.
:::
...
- [Rendering Pipeline](/dotnet/building-blocks/templating/rendering-pipeline/) -- five-stage pipeline from enrichment to transformation
- [Scriban Engine](/dotnet/building-blocks/templating/scriban-engine/) -- sandboxing, global contexts, includes
- [Layouts](/dotnet/building-blocks/templating/layouts/) -- two-pass rendering, tenant override, safety guards
- [Lifecycle & Admin API](/dotnet/building-blocks/templating/lifecycle/) -- state machine, workflow bridge, 17 admin endpoints
- [Post-Render Transformers](/dotnet/building-blocks/templating/post-render-transformers/) -- extensible HTML processing pipeline
...
- [Document Generation module](/dotnet/building-blocks/document-generation/) -- HTML-to-PDF (Chromium), Excel (ClosedXML), PDF/A-3b
