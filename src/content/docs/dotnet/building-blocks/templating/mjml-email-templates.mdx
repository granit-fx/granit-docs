...
- [Post-Render Transformers](./post-render-transformers/) — `MjmlTransformer` (Order=100) compilation step
- [Layouts](./layouts/) — the built-in `Layout.Email.html` wrapper
- [Rendering Pipeline](./rendering-pipeline/) — where MJML compilation runs in the pipeline
