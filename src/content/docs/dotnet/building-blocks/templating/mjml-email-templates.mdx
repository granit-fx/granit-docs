---
title: "MJML Email Templates — Responsive Email Without Node"
...
The `MjmlTransformer` (Order=100) runs in the [post-render pipeline](/dotnet/building-blocks/templating/post-render-transformers/). It auto-detects
...
- [Post-Render Transformers](/dotnet/building-blocks/templating/post-render-transformers/) — `MjmlTransformer` (Order=100) compilation step
- [Layouts](/dotnet/building-blocks/templating/layouts/) — the built-in `Layout.Email.html` wrapper
- [Rendering Pipeline](/dotnet/building-blocks/templating/rendering-pipeline/) — where MJML compilation runs in the pipeline
- [Email channel](/dotnet/infrastructure/notifications/email-channel/) — consumer of MJML output
