...
- [Rendering Pipeline](./rendering-pipeline/) — the five-stage pipeline
- [MJML Email Templates](./mjml-email-templates/) — the built-in Order=100 transformer
- [Scriban Engine](./scriban-engine/) — what runs before transformers
- [Configuration & API Reference](./reference/) — `ITextTemplateTransformer` contract
