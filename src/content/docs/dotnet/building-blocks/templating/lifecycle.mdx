...
- [Rendering Pipeline](/dotnet/building-blocks/templating/rendering-pipeline/) — how the resolver chain integrates with lifecycle
- [Layouts](/dotnet/building-blocks/templating/layouts/) — tenant overrides and the layout resolver
- [Configuration & API Reference](/dotnet/building-blocks/templating/reference/) — admin endpoint payloads and configuration
- [Workflow module](/dotnet/building-blocks/workflow/) — FSM engine powering the approval bridge
- [Authorization module](/dotnet/security/authorization/) — permission gating for admin endpoints
