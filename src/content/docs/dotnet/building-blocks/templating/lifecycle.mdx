...
- [Rendering Pipeline](./rendering-pipeline/) — how the resolver chain integrates with lifecycle
- [Layouts](./layouts/) — tenant overrides and the layout resolver
- [Configuration & API Reference](./reference/) — admin endpoint payloads and configuration
