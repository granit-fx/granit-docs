...
- [Rendering Pipeline](./rendering-pipeline/) — where the Scriban engine runs in the pipeline
- [Layouts](./layouts/) — two-pass rendering and shared envelope templates
- [Post-Render Transformers](./post-render-transformers/) — HTML processing after Scriban
- [MJML Email Templates](./mjml-email-templates/) — Scriban + MJML composition
- [Configuration & API Reference](./reference/) — sandbox options and engine knobs
