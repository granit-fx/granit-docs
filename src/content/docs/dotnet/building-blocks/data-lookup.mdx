...
description: Declarative registry of named lookup sources — feeds QueryEngine filter pickers and form dropdowns from one contract, with server-side label i18n.
sidebar:
  label: Data Lookup
  order: 17
---
...
- [QueryEngine](/dotnet/building-blocks/query-engine/) — declarative search; filter pickers
...
- [ADR-028](/dotnet/architecture/adr/028-unified-data-lookup/) —
  architectural rationale and scope (unified `ILookupSource` for ReferenceData and EF entities).
