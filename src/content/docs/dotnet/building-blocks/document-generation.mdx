...
description: Binary document generation pipeline — HTML to PDF through the Granit.Browsing abstraction (Chromium-backed), Excel via ClosedXML, and PDF/A-3b conversion for archival and electronic invoicing.
sidebar:
