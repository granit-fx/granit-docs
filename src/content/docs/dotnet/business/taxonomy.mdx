...
description: Shared Tag aggregate, polymorphic TagAssignment table, per-scope autocomplete, cross-entity search, and a hierarchical Category sibling for any aggregate.
sidebar:
  label: Taxonomy
  order: 22
---
