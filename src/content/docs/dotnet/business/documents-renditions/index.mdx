...
description: Asset derivatives for Granit.Documents — IRenditionProvider chains generate thumbnail, web, print, and poster renditions with sandboxed Office/PDF conversion.
sidebar:
...
- [Documents — Properties](/dotnet/business/documents-properties/) —
  ...
  previews; Properties produces searchable EXIF / PDF info / Office /
