...
description: Pluggable IAssetMetadataExtractor chain for Granit.Documents — projects EXIF, IPTC, XMP, PDF, Office, and A/V tags into typed columns plus GDPR GPS scrub.
sidebar:
