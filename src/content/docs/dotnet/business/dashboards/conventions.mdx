---
title: "Dashboards Conventions — Shape, Widgets, Wire Format"
description: "Declarative shape and wire format for Granit.Dashboards — DashboardDefinition fields, seven widget kinds, Datasource, actions, named views, filters."
sidebar:
  label: Conventions
  order: 10
---
