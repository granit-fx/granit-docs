---
title: "Dashboards — Composable widget grids"
description: "Granit.Dashboards — declarative DashboardDefinition with seven widget kinds (Markdown, Image, Text, Kpi, Chart, Table, Pivot), responsive layouts, named views."
sidebar:
  label: Overview
  order: 0
---
