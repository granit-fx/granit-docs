...
description: "Separate OData v4 mount for cross-tenant analytics by SuperAdmins — finance, compliance, capacity. Three strict gates make every EntitySet an auditable opt-in."
sidebar:
...
through `IPermissionDefinitionRegistry` at startup. The resolved
