...
description: Domain and integration events in a modular .NET monolith — Wolverine transactional outbox for guaranteed delivery with tenant/user/trace propagation.
sidebar:
  label: Messaging
  order: 6
---
