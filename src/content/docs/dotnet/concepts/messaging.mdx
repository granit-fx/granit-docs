...
description: Cross-module events survive crashes — the transactional outbox guarantees delivery, and tenant, user, and trace context propagate automatically on every message.
sidebar:
  label: Messaging
  order: 6
---
...
- [Wolverine Optionality](/dotnet/concepts/wolverine-optionality/) -- what works without Wolverine and when you actually need a message bus
