...
description: How Granit organizes 400+ NuGet packages via a [DependsOn] graph with DI ordering, lifecycle hooks, and conditional module activation.
sidebar:
  label: Module System
  order: 1
---
...
- [Bundles](/dotnet/concepts/bundles/) -- pre-composed module groups for common scenarios
