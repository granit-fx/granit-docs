...
description: Run Granit without Wolverine using Channel<T> fallbacks — which features need a message bus, which work in-process, and when to graduate to Wolverine.
sidebar:
