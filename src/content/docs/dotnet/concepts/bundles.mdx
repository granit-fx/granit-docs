...
description: "Meta-packages that group Granit modules by job — Essentials, Api, OpenIddict, Notifications, Documents, and SaaS. One PackageReference, one Add*() call."
sidebar:
  label: Bundles
  order: 10
---
