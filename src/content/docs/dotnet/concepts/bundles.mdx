...
| `Granit.Http.ApiDocumentation` | OpenAPI 3.1 + URL-segment versioning, per major API |
| `Granit.Http.ApiDocumentation.Scalar` | Scalar interactive UI (optional companion) |
