...
description: A one-way dependency graph keeps your codebase untangled — business modules build on framework infrastructure but never depend on each other, enforced in CI.
sidebar:
...
| `Http.Cookies` | 3 | Cookie consent (GDPR, CookieConsent CMP) |
...
| `Granit.Privacy.AI` | `Granit.Privacy` | `Granit.AI` |
| `Granit.Privacy.Auditing` | `Granit.Privacy` | `Granit.Auditing` |
...
- [Module System](/dotnet/concepts/module-system/) -- `[DependsOn]`, topological sort, lifecycle hooks
- [Bundles](/dotnet/concepts/bundles/) -- meta-packages for quick onboarding
