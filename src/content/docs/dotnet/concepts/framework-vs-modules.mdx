...
description: How Granit classifies packages into horizontal framework infrastructure and vertical business modules, with enforced dependency direction and CI guardrails.
sidebar:
