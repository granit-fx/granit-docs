...
description: Modular monolith vs microservices trade-offs — where Granit fits on the spectrum and a reversible migration path to extract services when scaling demands.
sidebar:
...
- [Blog: Why modular monolith](/blog/why-modular-monolith/) — the argument for the modular monolith default
- [Blog: Zero circular dependencies](/blog/zero-circular-dependencies/) — how the analyzer ban prevents accidental coupling
