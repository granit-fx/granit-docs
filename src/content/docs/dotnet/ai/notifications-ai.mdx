...
description: AI-generated notification content and channel routing — the LLM writes subject and body, then picks the optimal delivery channel per recipient.
sidebar:
  order: 8
  badge:
    text: New
