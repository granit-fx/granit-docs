---
title: "AI for .NET — 14 capabilities, one provider-agnostic core"
description: Granit ships LLMs, embeddings, semantic search, NLQ, document extraction, content moderation, and more as opt-in modules on top of Microsoft.Extensions.AI. Swap providers per environment. GDPR and ISO 27001 by design.
sidebar:
  label: Overview
  order: 1
---
