...
description: AI column mapping for CSV/Excel imports — when fuzzy matching falls short, the LLM bridges messy source files and your clean data model.
sidebar:
...
- [Data Exchange](/dotnet/building-blocks/data-exchange/) — the import/export module
