...
description: "Database reference for Granit.IoT — ER diagram, iot_* and iotaws_* tables, JSONB metric conventions, secrets-at-rest, migration ordering, sizing guidance."
sidebar:
  label: Data Model
  order: 3
---
