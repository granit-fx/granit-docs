...
8. ### Query telemetry
   ...
   <Tabs>
     <TabItem label="Time range">
       ```bash
       curl "https://your-app/iot/telemetry?filter[deviceId.eq]=$DEVICE_ID&filter[recordedAt.gte]=2026-05-20T00:00:00Z&filter[recordedAt.lte]=2026-05-20T23:59:59Z&sort=-recordedAt" \
         -H "Authorization: Bearer $TOKEN"
       ```
     </TabItem>
