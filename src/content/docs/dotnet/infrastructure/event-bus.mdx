...
description: Dual event bus for modular .NET — in-process and cross-service events with Wolverine outbox, guaranteed delivery, and automatic context propagation.
sidebar:
  label: Events
  order: 8
---
