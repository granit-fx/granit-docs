...
description: One-shot future execution of typed payloads — cancellation, rescheduling, atomic claim, catch-up safety, and audit trail. Complements recurring BackgroundJobs.
sidebar:
  label: Scheduling
  order: 11
---
