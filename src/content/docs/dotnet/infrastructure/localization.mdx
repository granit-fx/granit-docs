...
description: JSON-based i18n covering 18 cultures with CLDR plural rules, source-generated translation keys, per-tenant database overrides at runtime, culture fallback chains, and Minimal API endpoints.
sidebar:
  label: Localization
  order: 18
---
