...
- [Conventions](./conventions/) — provider registration, capability lookup, pool lifecycle
- [Security](./security/) — sandboxing untrusted content, URL allow-lists, resource limits
