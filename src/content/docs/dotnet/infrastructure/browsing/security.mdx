...
| --- | --- |
| `IUrlSafetyValidator` | Scheme/host/private-net/TLD/length pre-flight; resolves DNS. See [URL safety](/dotnet/http/url-safety/). |
...
- [URL Safety](/dotnet/http/url-safety/) — the shared SSRF primitive.
