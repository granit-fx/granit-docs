...
| Event | Type | Trigger | Compliance |
|-------|------|---------|------------|
| `IdentityUserUpdatedEvent` | Integration | Identity provider webhook | — |
| `IdentityUserDeletedEvent` | Integration | Identity provider webhook | GDPR Art. 17 |
...
| Event | Type | Trigger | Compliance |
|-------|------|---------|------------|
| `ImportJobCompletedEvent` | Integration | Import orchestrator | — |
| `ImportJobCancelledEvent` | Domain | `ImportJob.Cancel()` | ISO 27001 |
| `ExportJobCompletedEvent` | Integration | Export orchestrator | — |
