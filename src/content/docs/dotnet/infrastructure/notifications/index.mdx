...
- [Fan-Out Engine](./fan-out-engine/) — multi-channel dispatch, preference filtering, audit trail
- [Channels Overview](./channels/) — capability matrix across InApp, Email, SMS, Push, Realtime
- [Email Channel](./email-channel/) — SMTP, SendGrid, Azure, Scaleway, Brevo providers
- [SMS, Push & Real-Time](./sms-push-realtime/) — WhatsApp, FCM, SignalR, SSE, Web Push
- [Wolverine Integration](./wolverine-integration/) — durable outbox dispatch with retry
- [Data Model](./data-model/) — entities, CQRS stores, user preferences
- [Endpoints](./endpoints/) — inbox, preferences, subscriptions, follower REST API
- [Configuration](./configuration/) — options, health checks, provider selection
- [Package Conventions](./conventions/) — file layout, Wolverine handler shape, manifest pinning
- [Recipes](./recipes/) — workflow integration, authorization, encryption patterns
