...
- [Overview](./) — fan-out engine and package structure
- [Fan-out engine](./fan-out-engine/) — how preferences and definitions drive dispatch
- [Endpoints](./endpoints/) — REST API exposing preferences, subscriptions, followers
- [Package conventions](./conventions/) — module-local notification definition layout
