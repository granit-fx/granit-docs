---
title: "Notifications Endpoints — Inbox, Preferences, Push"
...
`Granit.Notifications.Endpoints` maps all endpoints under the `/notifications` prefix (configurable via `NotificationsEndpointsOptions.RoutePrefix`). All endpoints require authentication **and** a permission from `NotificationsPermissions`.
...
- [Overview](/dotnet/infrastructure/notifications/) — fan-out engine and setup
- [Data model](/dotnet/infrastructure/notifications/data-model/) — entities behind these endpoints
- [Configuration](/dotnet/infrastructure/notifications/configuration/) — health checks and OpenTelemetry tags
- [SMS, push & real-time](/dotnet/infrastructure/notifications/sms-push-realtime/) — channels behind the mobile push token endpoints
- [Authorization module](/dotnet/security/authorization/) — permission gating for `Manage` and `Read`
