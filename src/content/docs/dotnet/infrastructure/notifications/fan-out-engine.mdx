...
- [Channels](./channels/) — `INotificationChannel`, custom channel implementation
- [Data model](./data-model/) — `NotificationPreference`, recipient resolution
- [Wolverine integration](./wolverine-integration/) — durable outbox dispatch with retry
- [Configuration](./configuration/) — provider options and telemetry
