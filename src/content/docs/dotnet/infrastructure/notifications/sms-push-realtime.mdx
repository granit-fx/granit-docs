...
- [Channels overview](./channels/) — channel abstraction and registration
- [Email channel](./email-channel/) — sibling channel implementation
- [Configuration](./configuration/) — provider-specific options (FCM, SignalR, VAPID, Twilio…)
- [Endpoints](./endpoints/) — mobile push token registration, inbox, preferences
- [Wolverine integration](./wolverine-integration/) — durable retry for real-time delivery failures
