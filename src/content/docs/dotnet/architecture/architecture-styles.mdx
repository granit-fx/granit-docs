---
title: "Architecture Styles — DDD, Clean, Vertical Slices"
description: "DDD is a modeling approach, not an architecture style. Granit supports Clean Architecture and Vertical Slice — pick what fits your team and domain."
sidebar:
