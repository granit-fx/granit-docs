...
description: Five EF Core SaveChanges interceptors automate ISO 27001 audit, GDPR soft delete, optimistic concurrency, domain events, and entity versioning.
sidebar:
  label: Interceptors
  order: 3
---
