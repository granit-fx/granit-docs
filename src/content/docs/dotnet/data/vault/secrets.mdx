---
title: "Read secrets from any vault in .NET"
description: ISecretStore fetches mTLS certs, JWT keys, SMTP passwords, and API tokens from HashiCorp Vault, Azure, AWS, or GCP — versioned, cacheable, safe.
sidebar:
  order: 2
