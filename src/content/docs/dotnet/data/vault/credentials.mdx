---
title: "Dynamic database credentials in .NET"
description: IDatabaseCredentialProvider issues short-lived auto-rotating DB creds from HashiCorp Vault, Azure, AWS, or GCP — automatic lease renewal, zero downtime.
sidebar:
  order: 3
