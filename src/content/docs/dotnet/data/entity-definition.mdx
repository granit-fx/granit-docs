...
description: Declarative manifest for an entity's UI — identity, forms, detail view, lists, kanban, relations, actions. Frontend renders it with no per-entity React.
sidebar:
