...
description: Granit.Persistence.EntityFrameworkCore.Postgres adds opinionated Npgsql defaults, a pg_try_advisory_lock distributed migration lock, schema-per-tenant isolation, and a lightweight raw-connection health check.
sidebar:
