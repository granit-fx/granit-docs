---
title: Workspace
description: Navigation tree from GET /api/workspaces — sub-workspaces up to depth 4, permission gating, cross-workspace sharing, and a 5-tier landing resolver.
sidebar:
  label: Workspace
  order: 7
  badge:
