...
description: Secure MCP tools with Granit RBAC, sanitize PII for GDPR, enforce DPoP proof-of-possession, and use elicitation for human-in-the-loop confirmation flows.
sidebar:
  label: Security
  order: 4
  badge:
...
public sealed class NotificationMcpTools(INotificationPublisher publisher)
{
