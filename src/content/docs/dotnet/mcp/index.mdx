...
description: Turn any Granit module into an MCP server. AI agents (Claude, Copilot, Cursor) discover and invoke tools, resources, and prompts via Model Context Protocol.
sidebar:
  label: Overview
  order: 1
  badge:
...
- [Blog: Let AI agents use your .NET modules](/blog/let-ai-agents-use-your-dotnet-modules/) — practical patterns for exposing module capabilities to LLMs via MCP
