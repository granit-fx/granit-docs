...
description: Bridge external MCP tools into Granit.AI workspaces for IChatClient tool calling — cost-controlled sampling with rate limiting, token caps, and ISO 27001 audit.
sidebar:
