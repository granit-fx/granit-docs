...
description: Declare MCP tools with attributes, inject Granit services via DI, return rich content (text, images, resources), and add icons. Reference for Granit.Mcp.
sidebar:
