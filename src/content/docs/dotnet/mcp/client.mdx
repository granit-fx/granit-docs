...
description: Use IMcpClientFactory to connect Granit apps to external MCP servers over HTTP or stdio — named connections, credential forwarding, and configuration reference.
sidebar:
  label: Client
  order: 6
---
