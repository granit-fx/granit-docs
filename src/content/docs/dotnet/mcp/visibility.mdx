---
title: "MCP Tool Visibility — Discovery & Tenant Scoping"
description: Control which MCP tools AI agents see — opt-in discovery with McpExposed, per-tenant filtering with McpTenantScope, and module namespace scoping.
sidebar:
...
internal sealed class FeatureFlagVisibilityFilter(
    IFeatureChecker features) : IMcpToolVisibilityFilter
{
