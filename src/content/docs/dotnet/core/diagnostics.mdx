...
description: Kubernetes-native /health/live, /health/ready, /health/startup endpoints with stampede-protected caching and Grafana-friendly JSON output — health probes that survive load spikes without lying to the orchestrator.
sidebar:
  label: Diagnostics
  order: 5
---
