...
description: Extend any entity via IHasMetadata — JSON property bag plus optional SQL column promotion. No schema changes, no subclassing, auto Shadow Property sync.
sidebar:
  label: Metadata
  order: 9
  badge:
