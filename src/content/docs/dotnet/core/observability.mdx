...
| Security & identity | `Granit.Http.UrlSafety`, `Granit.DPoP`, `Granit.TokenManagement`, `Granit.OpenIddict`, `Granit.Identity`, `Granit.Identity.Local`, `Granit.Identity.{Cognito,EntraId,GoogleCloud,Keycloak}` |
