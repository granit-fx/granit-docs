...
description: Configure the data controller and DPO via Granit.Settings, inject them into templates via the privacy global context — GDPR Art. 13 transparency notices.
sidebar:
  order: 9
...
- [Templating](/dotnet/building-blocks/templating/) — Scriban engine, layouts, global contexts
