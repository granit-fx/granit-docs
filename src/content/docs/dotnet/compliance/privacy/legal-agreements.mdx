...
- [Processing Purposes](/dotnet/compliance/privacy/processing-purposes/) — legal basis declarations referenced by agreements
- [Regulations](/dotnet/compliance/privacy/regulations/) — multi-regulation engine driving consent prompts
- [Cookies overview](/dotnet/compliance/cookies/) — surface legal documents in the cookie banner
- [Templating module](/dotnet/building-blocks/templating/) — render legal document versions
- [Notifications module](/dotnet/infrastructure/notifications/) — re-consent notifications on `LegalAgreementObsoleteEto`
