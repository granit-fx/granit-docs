...
The [GPC signal](https://www.w3.org/TR/gpc/) (`Sec-GPC: 1`
...
- [Cookies overview](/dotnet/compliance/cookies/) — package structure and module setup
- [Consent Ledger](/dotnet/compliance/cookies/consent-ledger/) — append-only server-side proof of consent decisions
- [Klaro CMP (removed)](/dotnet/compliance/cookies/klaro/) — migrating to the CookieConsent `IConsentResolver`
- [Regulation Bridge](/dotnet/compliance/cookies/regulation-bridge/) — Privacy.Regulations bridge for GPC enforcement
- [Opt-Out (CCPA)](/dotnet/compliance/privacy/opt-out/) — anonymous opt-out for CCPA sale/share
- [Regulations](/dotnet/compliance/privacy/regulations/) — multi-regulation engine that drives GPC behavior
