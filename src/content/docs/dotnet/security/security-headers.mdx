...
description: HTTP security response headers for Granit APIs — HSTS, X-Content-Type-Options, X-Frame-Options, Referrer-Policy, Permissions-Policy. OWASP ASVS V14.4 compliant.
sidebar:
  order: 2
