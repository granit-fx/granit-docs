...
Additional scopes can be registered via the [admin API](/dotnet/security/openiddict/user-management/#oidc-scopes-apiadminoidcscopes)
or [declarative seeding](/dotnet/security/openiddict/configuration/#granitopeniddictseedingoptions).
...
| `granit.openiddict.authentication.successes` | Counter | `tenant_id` |
| `granit.openiddict.keys.rotated` | Counter | `tenant_id` |
