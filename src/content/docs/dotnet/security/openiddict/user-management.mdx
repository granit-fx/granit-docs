...
description: LocalIdentity entity, GranitRole, user groups, AspNetIdentityProvider bridge, admin REST API for users, roles, groups, OIDC applications, scopes, and authorizations.
sidebar:
  order: 3
