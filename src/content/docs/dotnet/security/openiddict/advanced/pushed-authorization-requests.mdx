...
description: "Secure OAuth 2.0 with Pushed Authorization Requests (RFC 9126) — move sensitive parameters from browser URLs to back-channel POSTs. Required for FAPI 2.0."
sidebar:
  order: 2
  label: PAR
  badge:
