...
description: "Authenticate OAuth 2.0 clients with signed JWT assertions (RFC 7523) instead of shared secrets — FAPI 2.0 ready, with EC P-256 keys and BFF integration."
sidebar:
  order: 3
