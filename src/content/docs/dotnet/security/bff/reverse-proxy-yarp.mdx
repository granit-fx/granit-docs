...
description: YARP configuration for BFF proxying — routes and clusters, token injection, CSRF validation, silent refresh, multi-service routing, and WebSocket support.
sidebar:
  order: 5
  label: YARP Proxy
---
