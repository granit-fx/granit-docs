...
- Granit.Identity.EntityFrameworkCore/ Durable `IUserSessionRiskStore` and `IDeviceTrustStore`, persisted in the Identity DbContext (`identity_user_session_risks`, `identity_device_trusts`)
</FileTree>
