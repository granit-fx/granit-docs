...
configurable via `GranitIdentitySessionDbProperties` (default prefix `user_sessions_`).
...
| Persistence | EF Core `IUserSessionRiskStore`, `GranitIdentitySessionDbProperties` | `Granit.Identity.EntityFrameworkCore` |
