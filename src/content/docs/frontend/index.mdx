...
| [`@granit/cookies-cookieconsent`](/frontend/security/cookies/) | vanilla-cookieconsent CMP adapter |
...
| `Granit.Http.Cookies` | `@granit/cookies`, `@granit/cookies-cookieconsent` |
