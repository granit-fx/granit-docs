...
description: Monitor background jobs in React with @granit/react-background-jobs — TanStack Query auto-polling, pause/resume/trigger mutations, live status.
sidebar:
...
- [.NET counterpart: Background Jobs](/dotnet/infrastructure/background-jobs/) — the server-side module behind this package
- [Granit.BackgroundJobs module](/dotnet/data/blob-storage/) — .NET background job scheduling with Wolverine and Cronos
- [Data Exchange](/frontend/business/data-exchange/) — Import/export jobs run as background jobs
