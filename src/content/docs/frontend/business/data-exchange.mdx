...
description: CSV and Excel import/export UIs with @granit/react-data-exchange — upload, column mapping, dry-run validation, job polling, and export presets.
sidebar:
  label: Data Exchange
  order: 10
---
...
- [.NET counterpart: Data Exchange](/dotnet/building-blocks/data-exchange/) — the server-side module behind this package
- [Granit.DataExchange module](/dotnet/building-blocks/data-exchange/) — .NET import/export pipeline (Extract → Map → Validate → Execute)
- [QueryEngine](/frontend/data/query-engine/) — Export jobs apply the same filter/sort/preset parameters
