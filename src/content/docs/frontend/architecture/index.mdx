...
description: Ship auth, data fetching, multi-tenancy, and observability in React 19 — a framework-agnostic TypeScript core with optional hooks, no .NET knowledge required.
sidebar:
...
graph TD
    ...
    subgraph "Infrastructure layer"
        ...
        cookies-cookieconsent["@granit/cookies-cookieconsent"]
    ...
    logger-otlp -.-> otel
    cookies-cookieconsent -.-> vcc["vanilla-cookieconsent"]
    ...
    style cookies-cookieconsent fill:#e3f2fd
