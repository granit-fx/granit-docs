...
description: Share state across @granit/* packages via the ES module cache — a zero-boilerplate singleton for Bearer tokens, log level, and cross-package state.
sidebar:
