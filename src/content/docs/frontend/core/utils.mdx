...
description: "@granit/utils — shared TypeScript helpers for Tailwind class merging via clsx/tailwind-merge, locale-aware numbers, and date-fns date formatting."
sidebar:
  label: Utils
  order: 2
---
...
- [QueryEngine](/frontend/data/query-engine/) — uses `cn()` for component styling, `formatDate()` for filter display
