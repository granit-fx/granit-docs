...
description: How @granit/react-authorization permissions interact with .NET enforcement. Why client-side checks are a UX hint and never a security boundary, with concrete do / do-not patterns for tenant switching, sensitive data fetching, and form gating.
sidebar:
