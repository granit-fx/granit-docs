...
description: GDPR cookie consent in React with @granit/react-cookies — pluggable CMP adapter, Klaro integration via @granit/cookies-klaro, category-aware context.
sidebar:
  label: Cookies
  order: 18
---
