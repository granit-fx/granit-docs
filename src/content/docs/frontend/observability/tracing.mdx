...
description: OpenTelemetry distributed tracing for React with @granit/tracing — OTLP export to Grafana Alloy or Aspire, auto-instrumentations, W3C propagation.
sidebar:
  label: Tracing
  order: 20
---
...
- [Logger](/frontend/observability/logger/) — `@granit/logger-otlp` uses `getTraceContext()` for log-trace correlation
