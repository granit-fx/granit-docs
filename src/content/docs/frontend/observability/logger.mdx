...
description: Structured browser logging with @granit/logger — severity, named prefixes, child loggers, and OTLP export with OpenTelemetry trace correlation.
sidebar:
  label: Logger
  order: 3
---
...
- [Tracing](/frontend/observability/tracing/) — OpenTelemetry browser tracing, `getTraceContext()` for correlation
- [Error boundary](/frontend/observability/error-boundary/) — uses `@granit/logger` for error reporting
