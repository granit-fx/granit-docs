...
description: Typed browser storage with @granit/storage — localStorage and sessionStorage factory, key prefixing, custom serialization, and cross-tab sync.
sidebar:
  label: Storage
  order: 19
---
...
- [Settings](/frontend/infrastructure/settings/) — Server-side cascaded settings complement client-side storage
