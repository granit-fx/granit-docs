...
description: Wire up Keycloak auth, the query engine, and multi-tenancy in minutes — the Granit TypeScript SDK plus React 19 hooks get your frontend production-ready fast.
sidebar:
