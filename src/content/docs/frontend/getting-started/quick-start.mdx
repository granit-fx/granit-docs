...
description: Integrate granit-front into a Vite/React 19 app in 5 steps — install @granit packages, wire Keycloak auth, set up the logger and typed API client.
sidebar:
  order: 50
---
