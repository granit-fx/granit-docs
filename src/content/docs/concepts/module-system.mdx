---
title: Module System
description: How Granit organizes 93 packages into a dependency graph with topological loading, lifecycle hooks, and conditional activation
sidebar:
  order: 1
---
...
ASP.NET Core gives you dependency injection but no concept of a **module**. When a framework grows to 93 packages, you hit real problems fast:
...
- [Core reference](/reference/modules/core/) -- full API surface of `Granit.Core`
