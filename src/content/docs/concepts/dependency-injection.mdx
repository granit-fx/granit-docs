...
The application only declares `[DependsOn(typeof(GranitAuthenticationKeycloakModule))]`.
...
93 packages, splitting would mean 186 packages — doubling the dependency graph
