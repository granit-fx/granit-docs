...
published to the [GitLab npm registry](/operations/frontend-npm-registry/).
...
- [Frontend SDK Reference](/reference/frontend/) — package documentation
- [Backend Architecture](/architecture/) — .NET architecture overview
- [Frontend Patterns](/architecture/patterns-frontend/) — design patterns
- [Frontend ADRs](/architecture/adr-frontend/) — architecture decision records
