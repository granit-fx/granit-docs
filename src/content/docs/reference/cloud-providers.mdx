...
| Domain | [AWS](#aws) | [Azure](#azure) | [Google Cloud](#google-cloud) |
| ------ | :---------: | :-------------: | :---------------------------: |
| Authentication | ✓ | ✓ | ✓ |
| Identity | ✓ | ✓ | ✓ |
| Vault / Encryption | ✓ | ✓ | ✓ |
| Blob Storage | ✓ | ✓ | ✓ |
| Notifications — Email | ✓ | ✓ | <span style="color: var(--sl-color-red);">✗</span> |
| Notifications — SMS | ✓ | ✓ | <span style="color: var(--sl-color-red);">✗</span> |
| Notifications — Mobile Push | ✓ | ✓ | ✓ |
| **Total packages** | **7** | **7** | **5** |
...
| Capability | AWS (Cognito) | Azure (Entra ID) | Google Cloud |
| ---------- | :-----------: | :---------------: | :----------: |
| JWT validation | ✓ | ✓ | ✓ |
...
| ---------- | :-----: | :-------------: | :--------------: |
| Encrypt / Decrypt | ✓ | ✓ | ✓ |
| Dynamic DB credentials | ✓ | <span style="color: var(--sl-color-red);">✗</span> | ✓ |
| Secret storage | ✓ | ✓ | ✓ |
| Key rotation | ✓ | ✓ | ✓ |
...
| Capability | AWS S3 | Azure Blob | Google Cloud Storage |
| ---------- | :----: | :--------: | :------------------: |
| Presigned upload | ✓ | ✓ | ✓ |
| Presigned download | ✓ | ✓ | ✓ |
| Tenant isolation | ✓ | ✓ | ✓ |
...
| Channel | AWS | Azure | Google Cloud |
| ------- | :-: | :---: | :----------: |
| Email | ✓ (SES) | ✓ (ACS) | <span style="color: var(--sl-color-red);">✗</span> |
| SMS | ✓ (SNS) | ✓ (ACS) | <span style="color: var(--sl-color-red);">✗</span> |
| Mobile Push | ✓ (SNS) | ✓ (ANH) | ✓ (FCM) |
