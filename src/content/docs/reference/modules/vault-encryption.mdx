...
- [Caching module](./caching.mdx) — AES-256 encryption for cached GDPR-sensitive data
- [Security module](./security.mdx) — Authorization and current user abstractions
- [Persistence module](./persistence.mdx) — EF Core interceptors, dynamic credentials integration
