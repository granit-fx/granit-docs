...
- [Wolverine module](./wolverine.mdx) -- Durable messaging, transactional outbox
- [Persistence module](./persistence.mdx) -- `AuditedEntity`, `Entity`, interceptors
- [Identity module](./identity.mdx) -- User lookup for `IRecipientResolver` implementation
- [Templating module](./templating.mdx) -- Scriban templates for email/SMS content
- [Core module](./core.mdx) -- `Entity`, `AuditedEntity`, `IMultiTenant`
