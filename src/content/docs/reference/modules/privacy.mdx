...
- [Security module](./security.mdx) — Authentication, authorization
- [Identity module](./identity.mdx) — GDPR erasure and pseudonymization on user cache
- [Core module](./core.mdx) — `ISoftDeletable`, data filter interfaces
