...
| Extensions | `AddGranitCaching()`, `AddGranitCachingRedis()`, `AddGranitCachingHybrid()`, `AddGranitRedisCheck()` | — |

## See also

- [Persistence module](./persistence.mdx) — EF Core interceptors, query filters
- [Security module](./security.mdx) — Authorization permission cache uses `ICacheService`
