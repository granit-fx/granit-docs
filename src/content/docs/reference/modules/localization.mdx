...
- [Settings, Features & Reference Data](./settings-features.mdx) -- uses localization for display names
- [Persistence module](./persistence.mdx) -- EF Core interceptors used by the override store
- [Security module](./security.mdx) -- permission-based access for override management
