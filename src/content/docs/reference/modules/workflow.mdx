...
sequenceDiagram
    ...
    Note over EV: Notifications module sends<br/>InApp + Email to approvers
```
...
- [Core module](./core.mdx) -- `IDomainEvent`, module system, `IPublishable`
- [Persistence module](./persistence.mdx) -- `AuditedEntityInterceptor`, `ApplyGranitConventions`
- [Security module](./security.mdx) -- `ICurrentUserService`, permission checking
- [Notifications module](./notifications.mdx) -- Notification engine, channels
- [Wolverine module](./wolverine.mdx) -- Domain event routing, transactional outbox
