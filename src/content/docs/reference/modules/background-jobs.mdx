...
- [Wolverine module](./wolverine.mdx) -- Transactional outbox, context propagation, retry policy
- [Persistence module](./persistence.mdx) -- `ApplyGranitConventions`, isolated DbContext pattern
- [Security module](./security.mdx) -- `ICurrentUserService` for audit trail propagation
- [Core module](./core.mdx) -- `IDomainEvent`, `Entity`, module system
