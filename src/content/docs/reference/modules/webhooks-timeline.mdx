...
- [Notifications module](./notifications.mdx) — Multi-channel notification engine used by Timeline.Notifications
- [Persistence module](./persistence.mdx) — EF Core interceptors, query filters
- [Wolverine module](./wolverine.mdx) — Messaging, transactional outbox
