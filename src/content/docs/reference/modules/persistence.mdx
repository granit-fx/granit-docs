...
- [Core module](./core.mdx) — domain base types, filter interfaces, `IDataFilter`
- [Multi-tenancy concept](../../concepts/multi-tenancy.md) — isolation strategies in depth
- [Security module](./security.mdx) — `ICurrentUserService` that feeds audit fields
- [Wolverine module](./wolverine.mdx) — domain event dispatch and durable messaging
