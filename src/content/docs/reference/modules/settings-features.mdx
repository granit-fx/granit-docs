...
- [Localization module](./localization.mdx) -- i18n for UI strings and error messages
- [Caching module](./caching.mdx) -- used by Settings and Features for value caching
- [Persistence module](./persistence.mdx) -- isolated DbContext pattern for all EF Core stores
- [Security module](./security.mdx) -- permission-based access for admin endpoints
