...
- [Core module](./core.mdx) — `IDomainEvent`, `IIntegrationEvent`, `IDomainEventDispatcher`
- [Persistence module](./persistence.mdx) — `DomainEventDispatcherInterceptor`, transactional outbox
- [Multi-tenancy module](./multi-tenancy.mdx) — Tenant context propagation
- [Security module](./security.mdx) — `ICurrentUserService` propagation
