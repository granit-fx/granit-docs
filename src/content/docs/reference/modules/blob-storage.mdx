...
- [Persistence module](./persistence.mdx) — EF Core interceptors, query filters
- [Security module](./security.mdx) — Authorization, tenant isolation
- [Privacy module](./privacy.mdx) — GDPR compliance patterns
- [Background Jobs module](./background-jobs.mdx) — Orphan cleanup, retention jobs
