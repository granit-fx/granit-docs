...
- [Core module](./core.mdx) — `IMultiTenant` interface, data filter
- [Persistence module](./persistence.mdx) — `ApplyGranitConventions`, isolation strategies
- [Wolverine module](./wolverine.mdx) — Tenant context propagation in messages
