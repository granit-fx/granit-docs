...
- [Security module](./security.mdx) — JWT Bearer authentication, authorization
- [Caching module](./caching.mdx) — `ICacheValueEncryptor` used by idempotency store
- [Core module](./core.mdx) — Exception hierarchy (`BusinessException`, `IHasErrorCode`)
- [Wolverine module](./wolverine.mdx) — Wolverine messaging pipeline, rate limit middleware
- [Utilities module](./utilities.mdx) — Validation, timing, GUID generation
