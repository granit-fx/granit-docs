...
<FileTree>
- src/Granit.Core/
  - Modularity/ GranitModule, GranitBuilder, DependsOnAttribute, ModuleLoader
  - Domain/ Entity, ValueObject, AggregateRoot, audit hierarchy, filter interfaces
  - DataFiltering/ IDataFilter, DataFilter
  - MultiTenancy/ ICurrentTenant, NullTenantContext
  - Events/ IDomainEvent, IIntegrationEvent, IDomainEventDispatcher
  - Exceptions/ BusinessException, ValidationException, EntityNotFoundException...
  - Endpoints/ ModuleConfigEndpointExtensions, BatchResult
  - Extensions/ GranitHostBuilderExtensions, GranitApplicationExtensions
  - Localization/ LocalizableString, LocalizationResourceNameAttribute
  - Diagnostics/ GranitActivitySourceRegistry
</FileTree>
...
- [Module system concept](../../concepts/module-system.md)
- [Persistence](./persistence.md) — EF Core interceptors that implement audit and soft delete
- [Security](./security.md) — `ICurrentUserService` that populates `CreatedBy` / `ModifiedBy`
- [Multi-tenancy](./multi-tenancy.md) — Full tenant isolation implementation
