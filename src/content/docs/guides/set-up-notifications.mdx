...
- [Implement webhooks](/guides/implement-webhooks/) for outbound system-to-system event delivery
- [Add background jobs](/guides/add-background-jobs/) for scheduled tasks
- [Granit.Notifications reference](/reference/modules/notifications/) for the full API surface and configuration options
