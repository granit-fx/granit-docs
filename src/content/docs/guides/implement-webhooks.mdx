...
- [Set up notifications](/guides/set-up-notifications/) for user-facing multi-channel notifications
- [Add background jobs](/guides/add-background-jobs/) for recurring scheduled tasks
- [Granit.Webhooks reference](/reference/modules/webhooks-timeline/) for the full store interfaces and database schema
