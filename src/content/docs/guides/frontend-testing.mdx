...
| Cobertura | `coverage/cobertura-coverage.xml` | GitLab CI (MR widget) |

## See also

- [Frontend Quick Start](/guides/frontend-quick-start/) — integrate granit-front
- [Frontend CI/CD](/operations/frontend-ci-cd/) — pipeline and quality gates
