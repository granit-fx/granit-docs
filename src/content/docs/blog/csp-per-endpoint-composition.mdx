---
title: "Content Security Policy in ASP.NET Core, Per Endpoint"
date: 2026-06-02
authors:
  - jfmeyers
tags:
  ...
  - security
  - architecture
description: "Per-endpoint CSP composition in ASP.NET Core — keep a strict Content Security Policy everywhere and relax it only on the routes that serve HTML."
excerpt: >
