...
tags:
  - architecture
  - decision
description: "Microservices are not a goal, they are a trade-off. Why Granit bets on the modular monolith — and how the framework makes extraction painless when needed."
excerpt: >
