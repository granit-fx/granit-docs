...
tags:
  ...
  - security
  - api
description: "Turn your .NET app into a self-hosted OIDC authorization server with Granit.OpenIddict — PKCE, client credentials, refresh tokens, multi-tenancy."
excerpt: >
...
- **Integration events** — `UserRegisteredEto`, `PasswordResetRequestedEto`, `AccountDeletedEto` published via Wolverine outbox; impersonation transparency rides the durable audit entry (`AuditEntryPersistedEto`)
