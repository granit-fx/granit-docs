...
tags:
  ...
  - tutorial
  - architecture
description: "Generate pixel-perfect invoices, contracts and reports from HTML templates in .NET. PuppeteerSharp renders, Scriban templates the data, Granit wires the pipeline."
excerpt: >
