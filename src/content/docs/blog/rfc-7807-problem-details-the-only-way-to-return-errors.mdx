...
```json
{
  ...
  "errors": {
    ...
    "Price": ["Validation:Builtin:GreaterThan"]
  }
}
```
...
- **Error codes over messages** — the frontend resolves `Validation:Builtin:NotEmpty` to localized strings. Ship codes, not strings.
