...
tags:
  ...
  - architecture
  - security
description: "Hardcoded connection strings and static API keys are a breach waiting to happen. HashiCorp Vault gives you dynamic credentials and transit encryption in .NET."
excerpt: >
