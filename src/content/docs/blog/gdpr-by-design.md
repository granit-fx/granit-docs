...
- [Granit.Privacy module reference](/reference/modules/privacy/) -- data export saga, deletion orchestration, legal agreements
- [Granit.Vault & Encryption reference](/reference/modules/vault-encryption/) -- Transit encryption, dynamic credentials, provider switching
- [Granit.Persistence reference](/reference/modules/persistence/) -- interceptors, soft delete, query filters, audit trail
- [Security model](/concepts/security-model/) -- authentication, authorization, and compliance architecture
