...
tags:
  ...
  - architecture
  - deep-dive
description: "Two-tier caches are fast, but cross-pod invalidation is what everyone gets wrong. How the L1 + L2 + backplane pattern works, and how Granit wires it up."
excerpt: >
