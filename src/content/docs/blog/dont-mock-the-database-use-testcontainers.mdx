...
tags:
  ...
  - testing
  - persistence
description: "EF Core InMemory and SQLite lie about PostgreSQL. Use Testcontainers to run real ephemeral databases in integration tests — zero mocks, zero surprises."
excerpt: >
