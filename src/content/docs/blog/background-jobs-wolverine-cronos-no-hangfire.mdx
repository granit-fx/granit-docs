...
tags:
  ...
  - best-practice
  - comparison
description: "Hangfire is great until you need cluster-safe scheduling, exactly-once semantics and a transactional outbox. Wolverine + Cronos gives all three with less ops."
excerpt: >
