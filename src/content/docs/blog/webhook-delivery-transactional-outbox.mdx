...
tags:
  ...
  - deep-dive
  - resilience
description: "Webhooks fail silently when you fire-and-forget after commit. How Granit uses the transactional outbox pattern to guarantee at-least-once delivery with HMAC signing."
excerpt: >
