...
tags:
  ...
  - security
  - api
description: "Wire Keycloak JWT Bearer auth into a Granit API in five minutes — claims transformation, role mapping, back-channel logout, Admin policy, one DependsOn."
excerpt: >
