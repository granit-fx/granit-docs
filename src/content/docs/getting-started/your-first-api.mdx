...
You just wrote zero DI configuration code. The module system registered `IClock` for you — that is the pattern for all 93 Granit packages. Declare a dependency, and the module handles registration.
:::
